...
namespace Mitrablog.Migrations
{
    ...
    [Migration("20201002125736_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mitrablog.Models.Account.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Mitrablog.Models.Account.AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Mitrablog.Models.Comment", b =>
                {
                    b.HasOne("Mitrablog.Models.Posts.Post")
                        .WithMany("Comments")
